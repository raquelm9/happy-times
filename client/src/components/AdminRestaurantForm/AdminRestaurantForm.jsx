...
import '../../pages/AdminRestaurants/AdminRestaurants.css'
                ...
                {({ touched, errors, isSubmitting, setFieldValue }) => (
                  <Form>
                    ...
                    <div className="row">
                      <div className="col-lg-6">
                        <div className="form-group">
                          <label htmlFor="addressLatitude">Latitude</label>
                          <Field
                      ...
                      <div className="col-lg-6">
                        <div className="form-group">
                          <label htmlFor="addressLongitude">Longitude</label>
                          <Field
                    ...
                    <div className="row">
                      <div className="col-12">
                        <button
                          ...
                          onClick={this.goToAdminList.bind(this)}
                        >
                          Cancel
                        </button>
